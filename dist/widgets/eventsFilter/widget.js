...
var EventFilter = function (_React$Component) {
    (0, _inherits3.default)(EventFilter, _React$Component);

    function EventFilter(props, context) {
        (0, _classCallCheck3.default)(this, EventFilter);

        var _this = (0, _possibleConstructorReturn3.default)(this, (EventFilter.__proto__ || (0, _getPrototypeOf2.default)(EventFilter)).call(this, props, context));

        _this.state = EventFilter.initialState;
        _this.dirty = {};
        return _this;
    }
    ...
    (0, _createClass3.default)(EventFilter, [{
        ...
        key: '_renderLabel',
        value: function _renderLabel(data, index, defaultLabelProps) {
            return _.truncate(data.text, { 'length': 10 });
        }
    }, {
        key: '_updateFieldState',
        value: function _updateFieldState(fieldName, fieldValue) {
        ...
        value: function _resetFilter() {
            ...
            var fields = (0, _assign2.default)({}, EventFilter.initialState.fields);
            this.setState({ fields: fields });
        ...
        value: function render() {
            ...
            var blueprints = (0, _assign2.default)({}, { items: [] }, this.props.data.blueprints);
            var blueprintOptions = _.map(blueprints.items, function (item) {
                return { text: item.id, value: item.id };
            });

            var deployments = (0, _assign2.default)({}, { items: [] }, this.props.data.deployments);
            var deploymentOptions = _.map(deployments.items, function (item) {
                return { text: item.id, value: item.id };
            });

            var types = (0, _assign2.default)({}, { items: [] }, this.props.data.types);
            var typeOptions = _.map(types.items, function (item) {
                return { text: item.event_type, value: item.event_type };
            });

            var logOptions = _.map(LOG_LEVELS, function (item) {
                return { text: _.capitalize(item), value: item };
            });
            ...
            return React.createElement(
                ...
                React.createElement(
                    Form.Group,
                    { inline: true, widths: '4' },
                    React.createElement(
                        Form.Field,
                        null,
                        React.createElement(Form.Dropdown, { placeholder: 'Blueprints', fluid: true, multiple: true, search: true, selection: true, options: blueprintOptions,
                            name: 'blueprintId', renderLabel: this._renderLabel.bind(this), closeOnChange: true,
                            value: this.state.fields.blueprintId, onChange: this._handleInputChange.bind(this) })
                    ),
                    React.createElement(
                        Form.Field,
                        null,
                        React.createElement(Form.Dropdown, { placeholder: 'Deployments', fluid: true, multiple: true, search: true, selection: true, options: deploymentOptions,
                            name: 'deploymentId', renderLabel: this._renderLabel.bind(this), closeOnChange: true,
                            value: this.state.fields.deploymentId, onChange: this._handleInputChange.bind(this) })
                    ),
                    React.createElement(
                        Form.Field,
                        null,
                        React.createElement(Form.InputDateRange, { fluid: true, placeholder: 'Time Range', name: 'timeRange',
                            value: this.state.fields.timeRange, onChange: this._handleInputChange.bind(this) })
                    ),
                    React.createElement(
                        Form.Field,
                        null,
                        this._isDirty() && React.createElement(Button, { icon: 'remove', basic: true, onClick: this._resetFilter.bind(this) })
                    )
                ),
                React.createElement(
                    Form.Group,
                    ...
                    React.createElement(
                        Form.Field,
                        null,
                        React.createElement(Form.Dropdown, { placeholder: 'Log Levels', fluid: true, multiple: true, search: true, selection: true, options: logOptions,
                            name: 'logLevel', closeOnChange: true,
                            value: this.state.fields.logLevel, onChange: this._handleInputChange.bind(this) })
                    ),
                    React.createElement(
                        Form.Field,
                        null,
                        React.createElement(Form.Dropdown, { placeholder: 'Event Types', fluid: true, multiple: true, search: true, selection: true, options: typeOptions,
                            name: 'eventType', renderLabel: this._renderLabel.bind(this), closeOnChange: true,
                            value: this.state.fields.eventType, onChange: this._handleInputChange.bind(this) })
                    ),
                    React.createElement(
                        Form.Field,
                        null,
                        React.createElement(Form.Input, { placeholder: 'Message Text', fluid: true, name: 'messageText',
...
},{"babel-runtime/core-js/object/assign":1,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":11,"babel-runtime/helpers/possibleConstructorReturn":12}],108:[function(require,module,exports){
'use strict';
...
Stage.defineWidget({
    ...
    fetchData: function fetchData(widget, toolbox, params) {
        return _promise2.default.all([toolbox.getManager().doGetFull('/blueprints?_include=id'), toolbox.getManager().doGetFull('/deployments?_include=id,blueprint_id'), toolbox.getManager().doGetFull('/events?_include=event_type&type=cloudify_event')]).then(function (results) {
            return {
    ...
    _processData: function _processData(blueprintId, deploymentId, data) {
