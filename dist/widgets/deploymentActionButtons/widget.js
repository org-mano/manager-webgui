...
var DeploymentActionButtons = function (_React$Component) {
    (0, _inherits3.default)(DeploymentActionButtons, _React$Component);

    function DeploymentActionButtons(props, context) {
        (0, _classCallCheck3.default)(this, DeploymentActionButtons);

        var _this = (0, _possibleConstructorReturn3.default)(this, (DeploymentActionButtons.__proto__ || (0, _getPrototypeOf2.default)(DeploymentActionButtons)).call(this, props, context));
    ...
    (0, _createClass3.default)(DeploymentActionButtons, [{
        key: 'shouldComponentUpdate',
        value: function shouldComponentUpdate(nextProps, nextState) {
            return this.props.widget !== nextProps.widget || this.state != nextState || !_.isEqual(this.props.deployment, nextProps.deployment);
        }
    }, {
        ...
        value: function _deleteDeployment() {
            ...
            actions.doDelete(this.props.deployment).then(function () {
        ...
        value: function _showExecuteWorkflowModal(workflow) {
        ...
        value: function render() {
            ...
            var deploymentId = this.props.deployment.id;
            ...
            return React.createElement(
                ...
                React.createElement(
                    PopupMenu,
                    { className: 'workflowAction', position: 'bottom center', offset: 0 },
                    React.createElement(
                        Popup.Trigger,
                        null,
                        React.createElement(Button, { className: 'labeled icon', color: 'teal', icon: 'content',
                            disabled: _.isEmpty(deploymentId) || this.state.loading, content: 'Execute workflow' })
                    ),
                    React.createElement(
                        Menu,
                        { vertical: true },
                        _.map(this.props.deployment.workflows, function (workflow) {
                            return React.createElement(Menu.Item, { name: _.capitalize(_.lowerCase(workflow.name)), key: workflow.name,
                                onClick: _this3._showExecuteWorkflowModal.bind(_this3, workflow) });
                        })
                    )
                ),
                React.createElement(Button, { className: 'labeled icon', color: 'teal', icon: 'edit', disabled: _.isEmpty(deploymentId) || this.state.loading,
                    onClick: this._showModal.bind(this, DeploymentActionButtons.EDIT_ACTION),
                    content: 'Update deployment' }),
                React.createElement(Button, { className: 'labeled icon', color: 'teal', icon: 'trash', disabled: _.isEmpty(deploymentId) || this.state.loading,
                    onClick: this._showModal.bind(this, DeploymentActionButtons.DELETE_ACTION),
                    content: 'Delete deployment' }),
                React.createElement(Confirm, { content: 'Are you sure you want to remove deployment ' + deploymentId + '?',
    ...
    return DeploymentActionButtons;
}(React.Component);

DeploymentActionButtons.EDIT_ACTION = 'edit';
DeploymentActionButtons.DELETE_ACTION = 'delete';
DeploymentActionButtons.WORKFLOW_ACTION = 'workflow';
DeploymentActionButtons.EMPTY_DEPLOYMENT = { id: '', workflows: [] };
DeploymentActionButtons.EMPTY_WORKFLOW = { name: '', parameters: [] };
exports.default = DeploymentActionButtons;
...
var _DeploymentActionButtons = require('./DeploymentActionButtons');

var _DeploymentActionButtons2 = _interopRequireDefault(_DeploymentActionButtons);
...
Stage.defineWidget({
    ...
    fetchData: function fetchData(widget, toolbox) {
        ...
        if (!_.isEmpty(deploymentId)) {
            ...
            return toolbox.getManager().doGet('/deployments/' + deploymentId).then(function (deployment) {
                toolbox.loading(false);

                var dep = (0, _assign2.default)({}, deployment, {
                    workflows: _.sortBy(deployment.workflows, ['name'])
                });
                return _promise2.default.resolve(dep);
            });
        }

        return _promise2.default.resolve(_DeploymentActionButtons2.default.EMPTY_DEPLOYMENT);
    },
    ...
    render: function render(widget, data, error, toolbox) {
        ...
        return React.createElement(_DeploymentActionButtons2.default, { deployment: data, widget: widget, toolbox: toolbox });
    }
