...
var AngularAppManager = function () {
    function AngularAppManager() {
        (0, _classCallCheck3.default)(this, AngularAppManager);
    ...
    (0, _createClass3.default)(AngularAppManager, [{
        key: 'start',
...
},{"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10}],108:[function(require,module,exports){
'use strict';
...
var DataFetcher = function () {
    ...
    (0, _createClass3.default)(DataFetcher, null, [{
        key: 'fetch',
        value: function fetch(toolbox, blueprintId, deploymentId) {
            var _this = this;
            ...
            if (deploymentId) {
                var fetchDeployment = _promise2.default.resolve({ blueprint_id: blueprintId });
                if (!blueprintId) {
                    fetchDeployment = toolbox.getManager().doGet('/deployments?id=' + deploymentId + '&_include=id,blueprint_id').then(function (deployments) {
                        var deployment = _.get(deployments, 'items[0]', null);
                        if (!deployment) {
                            return _promise2.default.reject(new Error('Cannot find deployment'));
                        } else {
                            return _promise2.default.resolve(deployment);
                        }
                    });
                }

                return fetchDeployment.then(function (deployment) {
                    return _promise2.default.all([toolbox.getManager().doGet('/blueprints?id=' + deployment.blueprint_id), toolbox.getManager().doGet('/nodes?deployment_id=' + deploymentId), toolbox.getManager().doGet('/node-instances?deployment_id=' + deploymentId), toolbox.getManager().doGet('/executions?_include=id,workflow_id,status&deployment_id=' + deploymentId + '&status=pending&status=started&status=cancelling&status=force_cancelling').then(function (executions) {
                        return _promise2.default.resolve(_.first(executions.items));
                    })]).then(function (data) {
                        ...
                        blueprintPlan.nodes = _this.sortNodesById(blueprintPlan.nodes);
                        nodes = _this.sortNodesById(nodes);
                        ...
                        blueprint.plan = (0, _assign2.default)({}, blueprintPlan, {
                            nodes: nodes
                        });
                        ...
                        return _promise2.default.resolve(topologyData);
                    });
                });
            } else if (blueprintId) {
                return toolbox.getManager().doGet('/blueprints?id=' + blueprintId).then(function (blueprint) {
                    return _promise2.default.resolve({ data: _.get(blueprint, 'items[0]', {}) });
                });
            }
        }
    }, {
        key: 'sortNodesById',
        value: function sortNodesById(nodes) {
...
},{"babel-runtime/core-js/object/assign":1,"babel-runtime/core-js/promise":6,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10}],109:[function(require,module,exports){
'use strict';
...
var Topology = function (_React$Component) {
    (0, _inherits3.default)(Topology, _React$Component);
    ...
    function Topology(props, context) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (Topology.__proto__ || (0, _getPrototypeOf2.default)(Topology)).call(this, props, context));
    ...
    (0, _createClass3.default)(Topology, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
            return this.props.widget !== nextProps.widget || this.state != nextState || !_.isEqual(this.props.data, nextProps.data) || !_.isEqual(this.props.template, nextProps.template);
        }
    }, {
        ...
        value: function _setStyle() {
            ...
            var loadingHtml = Stage.ComponentToHtmlString(React.createElement(Stage.Basic.Loading, null));
...
},{"./AngularAppManager":107,"./TopologyAngularApp.js":110,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":11,"babel-runtime/helpers/possibleConstructorReturn":12}],110:[function(require,module,exports){
'use strict';
...
angular.module('topologyApp', ['cfy.topology']).controller('topologyController', ['$scope', 'DataProcessingService', '$rootScope', function ($scope, DataProcessingService, $rootScope) {
...
Stage.defineWidget({
    ...
    isReact: true,
    hasTemplate: true,
    initialConfiguration: [Stage.GenericConfig.POLLING_TIME_CONFIG(2), { id: 'enableNodeClick', name: 'Enable node click', default: true, type: Stage.Basic.GenericField.BOOLEAN_TYPE }, { id: 'enableGroupClick', name: 'Enable group click', default: true, type: Stage.Basic.GenericField.BOOLEAN_TYPE }, { id: 'enableZoom', name: 'Enable zoom', default: true, type: Stage.Basic.GenericField.BOOLEAN_TYPE }, { id: 'enableDrag', name: 'Enable drag', default: true, type: Stage.Basic.GenericField.BOOLEAN_TYPE }, { id: 'showToolbar', name: 'Show toolbar', default: true, type: Stage.Basic.GenericField.BOOLEAN_TYPE }],
    ...
    fetchData: function fetchData(widget, toolbox) {
        ...
        return _DataFetcher2.default.fetch(toolbox, blueprintId, deploymentId);
    },
