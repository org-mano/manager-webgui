...
var _class = function (_React$Component) {
    ...
    (0, _createClass3.default)(_class, [{
        ...
        value: function render() {
            ...
            var outputs = this.props.data.items;
                    ...
                    outputs.sort(compareNames).map(function (output) {
                        return React.createElement(
                            ...
                            React.createElement(
                                DataTable.Data,
                                null,
                                output.value && React.createElement(
                                    Popup,
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            'span',
                                            null,
                                            JsonUtils.stringify(output.value, false)
                                        )
                                    ),
                                    React.createElement(
                                        HighlightText,
...
Stage.defineWidget({
    ...
    fetchData: function fetchData(widget, toolbox) {
        ...
        var _stringify = this._stringify;

        if (deploymentId) {
            var deploymentOutputsPromise = toolbox.getManager().doGet("/deployments/" + deploymentId + "/outputs");
            var deploymentPromise = toolbox.getManager().doGet("/deployments/" + deploymentId + "?_include=outputs");

            return _promise2.default.all([deploymentOutputsPromise, deploymentPromise]).then(function (data) {
                var deploymentOutputs = _.get(data[0], 'outputs', {});
                var deployment = _.get(data[1], 'outputs', {});
                return _promise2.default.resolve({
                    outputs: _.map(deployment, function (outputObject, outputName) {
                        return {
                            name: outputName,
        ...
        if (blueprintId) {
            return toolbox.getManager().doGet("/blueprints/" + blueprintId + "?_include=plan").then(function (data) {
                var blueprintOutputs = _.get(data, 'plan.outputs', {});
                return _promise2.default.resolve({
                    outputs: _.map(blueprintOutputs, function (outputObject, outputName) {
                        return {
                            name: outputName,
        ...
        return _promise2.default.resolve({ outputs: [] });
    },
