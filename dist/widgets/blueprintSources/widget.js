...
var BlueprintSources = function (_React$Component) {
    (0, _inherits3.default)(BlueprintSources, _React$Component);

    function BlueprintSources(props, context) {
        (0, _classCallCheck3.default)(this, BlueprintSources);

        var _this = (0, _possibleConstructorReturn3.default)(this, (BlueprintSources.__proto__ || (0, _getPrototypeOf2.default)(BlueprintSources)).call(this, props, context));

        _this.state = BlueprintSources.initialState;
        return _this;
    }

    (0, _createClass3.default)(BlueprintSources, [{
        ...
        key: "_selectFile",
        value: function _selectFile(selectedKeys, info) {
            var _this2 = this;
            ...
            actions.doGetFileContent(path).then(function (data) {
                var type = "basic";
                ...
                _this2.setState({ content: data, filename: info.node.props.title.props.children[1], type: type, error: "" });
            }).catch(function (err) {
                _this2.setState({ error: err.message, content: "", filename: "" });
                _this2.props.toolbox.loading(false);
            });
        }
    }, {
        ...
        value: function render() {
            ...
            var _Stage$Basic = Stage.Basic,
                NodesTree = _Stage$Basic.NodesTree,
                ...
                SplitterLayout = _Stage$Basic.SplitterLayout;
                        ...
                        return React.createElement(
                            ...
                            { key: item.key,
                                title: React.createElement(
                                    "span",
                                    null,
                                    React.createElement(Icon, { className: "treeIcon", name: "folder open outline" }),
                                    item.title
                                ) },
                            loop(item.children)
                        );
                    }
                    return React.createElement(NodesTree.Node, { key: item.key,
                        title: React.createElement(
                            "span",
                            null,
                            React.createElement(Icon, { className: "treeIcon", name: "file outline" }),
                            item.title
                        ) });
                });
            };
            ...
            return React.createElement(
                ...
                this.props.data.blueprintId ? React.createElement(
                    SplitterLayout,
                    { primaryIndex: 0, percentage: true, secondaryInitialSize: this.props.widget.configuration.contentPaneWidth },
                    React.createElement(
                        "div",
                        null,
                        React.createElement(
                            NodesTree,
                            { showLine: true, selectable: true, defaultExpandAll: true, onSelect: this._selectFile.bind(this) },
                            React.createElement(
                                NodesTree.Node,
                                { title: React.createElement(
                                        Label,
                                        { color: "purple", horizontal: true },
                    ...
                    this.state.content ? React.createElement(
                        ...
                        React.createElement(
                            Label,
                            { attached: "top right", size: "small", onClick: function onClick() {
                                    return _this3.refs.contentOverlay.show();
                                } },
                            React.createElement(Icon, { name: "maximize", link: true }),
                            this.state.filename
                        ),
                        React.createElement(
                            Overlay,
                        ...
                        "div",
                        { className: "verticalCenter centeredIcon" },
                        React.createElement(Icon, { name: "file outline", size: "big", color: "grey" })
                    )
                ) : React.createElement(
                    "div",
                    null,
                    React.createElement(Message, { content: "Please select blueprint to display source files", info: true })
                )
            );
        }
    }]);
...
BlueprintSources.initialState = {
    content: "",
    filename: "",
    error: "",
    type: "json"
};
exports.default = BlueprintSources;
;

},{"./actions":104,"babel-runtime/core-js/object/get-prototype-of":3,"babel-runtime/helpers/classCallCheck":8,"babel-runtime/helpers/createClass":9,"babel-runtime/helpers/inherits":10,"babel-runtime/helpers/possibleConstructorReturn":11}],104:[function(require,module,exports){
"use strict";
...
var _class = function () {
    ...
    (0, _createClass3.default)(_class, [{
        ...
        key: "doGetBlueprintDetails",
        value: function doGetBlueprintDetails(blueprintId) {
            return this.toolbox.getManager().doGet("/blueprints/" + blueprintId + "?_include=updated_at");
        }
    }, {
        key: "doGetFilesTree",
        value: function doGetFilesTree(blueprintId, lastUpdate) {
            return this.toolbox.getManager().doGet("/source/browse?[manager]/blueprints/" + blueprintId + "/archive", { last_update: lastUpdate });
        }
    }, {
        key: "doGetFileContent",
        value: function doGetFileContent(path) {
            return this.toolbox.getExternal().doGet("/source/browse/file", { path: path });
        }
    }]);
    return _class;
}();
...
var _BlueprintSources = require('./BlueprintSources');

var _BlueprintSources2 = _interopRequireDefault(_BlueprintSources);
...
Stage.defineWidget({
    ...
    isReact: true,
    hasStyle: true,
    initialConfiguration: [{ id: "contentPaneWidth", name: "Content pane initial width in %", default: 65, type: Stage.Basic.GenericField.NUMBER_TYPE }],
    ...
    fetchData: function fetchData(widget, toolbox, params) {
        var actions = new _actions2.default(toolbox);

        var blueprintId = params.blueprint_id;
        var deploymentId = params.deployment_id;

        var promise = _promise2.default.resolve({ blueprint_id: blueprintId });
        if (!blueprintId && deploymentId) {
            promise = actions.doGetBlueprintId(deploymentId);
        }

        return promise.then(function (_ref) {
            var blueprint_id = _ref.blueprint_id;

            blueprintId = blueprint_id;

            if (blueprintId) {
                return actions.doGetBlueprintDetails(blueprintId).then(function (data) {
                    var lastUpdate = Stage.Utils.formatTimestamp(data.updated_at, 'DDMMYYYYHHmm');
                    return actions.doGetFilesTree(blueprintId, lastUpdate).then(function (tree) {
                        return _promise2.default.resolve({ tree: tree, blueprintId: blueprintId });
                    });
                });
            } else {
                return _promise2.default.resolve({ tree: {} });
            }
        });
    },
