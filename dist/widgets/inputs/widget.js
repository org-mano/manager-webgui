...
var _class = function (_React$Component) {
    ...
    (0, _createClass3.default)(_class, [{
        ...
        value: function componentDidUpdate(prevProps, prevState) {
            if (this.props.data.deploymentId !== prevProps.data.deploymentId || this.props.data.blueprintId !== prevProps.data.blueprintId) {
                this._refreshData();
            }
        }
    }, {
        ...
        value: function render() {
            ...
            var inputs = this.props.data.items;
            var compareNames = function compareNames(a, b) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    DataTable,
                    { className: 'inputsTable', noDataAvailable: _.isEmpty(inputs) },
                    React.createElement(DataTable.Column, { label: 'Name', width: '35%' }),
                    React.createElement(DataTable.Column, { label: 'Value', width: '65%' }),
                    inputs.sort(compareNames).map(function (input) {
                        return React.createElement(
                            DataTable.Row,
                            { key: input.name },
                            React.createElement(
                                ...
                                input.value && React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            'span',
                                            null,
                                            JsonUtils.stringify(input.value, false)
                                        )
                                    ),
                                    React.createElement(
                                        HighlightText,
...
Stage.defineWidget({
    ...
    color: "teal",
    isReact: true,
    initialConfiguration: [Stage.GenericConfig.POLLING_TIME_CONFIG(2)],
    ...
    fetchData: function fetchData(widget, toolbox) {
        ...
        if (deploymentId) {
            var deploymentInputsPromise = toolbox.getManager().doGet('/deployments/' + deploymentId + '?_include=blueprint_id,inputs');
            var blueprintInputsPromise = deploymentInputsPromise.then(function (data) {
                return toolbox.getManager().doGet('/blueprints/' + data.blueprint_id + '?_include=plan');
            });

            return _promise2.default.all([deploymentInputsPromise, blueprintInputsPromise]).then(function (data) {
                var deploymentInputs = _.get(data[0], 'inputs', {});
                var blueprintsInputs = _.get(data[1], 'plan.inputs', {});
                return _promise2.default.resolve({
                    inputs: _.map(deploymentInputs, function (inputObject, inputName) {
                        return {
                            name: inputName,
                            value: inputObject,
        ...
        if (blueprintId) {
            return toolbox.getManager().doGet('/blueprints/' + blueprintId + '?_include=plan').then(function (data) {
                var deploymentInputs = _.get(data, 'plan.inputs', {});
                return _promise2.default.resolve({
                    inputs: _.map(deploymentInputs, function (inputObject, inputName) {
                        return {
                            name: inputName,
        ...
        return _promise2.default.resolve({ inputs: [] });
    },
