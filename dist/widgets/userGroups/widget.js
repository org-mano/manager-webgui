...
var CreateModal = function (_React$Component) {
    ...
    (0, _createClass3.default)(CreateModal, [{
        ...
        value: function _submitCreate() {
            ...
            actions.doCreate(this.state.groupName, this.state.ldapGroup).then(function () {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Form.Input, { name: "groupName", placeholder: "Group name",
                                value: this.state.groupName, onChange: this._handleInputChange.bind(this) })
                        ),
                        React.createElement(
                            Form.Field,
                            { error: this.state.errors.ldapGroup },
                            React.createElement(Form.Input, { name: "ldapGroup", placeholder: "LDAP group name",
...
var UserDetails = function (_React$Component) {
    ...
    (0, _createClass3.default)(UserDetails, [{
        ...
        value: function _removeTenant(tenant) {
            ...
            var actions = new _actions2.default(this.props.toolbox);
            actions.doRemoveTenantFromGroup(tenant, this.props.data.name).then(function () {
                _this2.props.toolbox.refresh();
        ...
        value: function _removeUser(username) {
            ...
            var actions = new _actions2.default(this.props.toolbox);
            actions.doRemoveUserFromGroup(username, this.props.data.name).then(function () {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    ' Users',
                    !_.isEmpty(this.props.data.users) && React.createElement(
                        'div',
                        null,
                        ...
                        React.createElement(
                            ...
                            this.props.data.users.map(function (item) {
                                ...
                                return React.createElement(
                                    ...
                                    React.createElement(Icon, { size: 'small', link: true, name: processing ? 'notched circle' : 'remove', loading: processing,
                                        className: 'right floated', onClick: _this4._removeUser.bind(_this4, item) })
                                );
                            })
                        )
                    ),
                    _.isEmpty(this.props.data.users) && React.createElement(Message, { content: 'No users available' })
                ),
                React.createElement(
                    Segment,
                    null,
...
},{"./actions":114,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":12,"babel-runtime/helpers/possibleConstructorReturn":13}],110:[function(require,module,exports){
'use strict';
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Menu.Item, { icon: 'users', content: 'Edit group\'s users', name: MenuAction.EDIT_USERS_ACTION,
                        onClick: this._actionClick.bind(this) }),
                    React.createElement(Menu.Item, { icon: 'user', content: 'Edit group\'s tenants', name: MenuAction.EDIT_TENANTS_ACTION,
                        onClick: this._actionClick.bind(this) }),
...
var TenantsModal = function (_React$Component) {
    (0, _inherits3.default)(TenantsModal, _React$Component);

    function TenantsModal(props, context) {
        (0, _classCallCheck3.default)(this, TenantsModal);

        var _this = (0, _possibleConstructorReturn3.default)(this, (TenantsModal.__proto__ || (0, _getPrototypeOf2.default)(TenantsModal)).call(this, props, context));

        _this.state = TenantsModal.initialState;
        return _this;
    }

    (0, _createClass3.default)(TenantsModal, [{
        key: 'onApprove',
        value: function onApprove() {
            this._submitTenants();
            return false;
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (!this.props.open && nextProps.open) {
                this.setState((0, _extends3.default)({}, TenantsModal.initialState, { tenants: nextProps.group.tenants }));
            }
        }
    }, {
        key: '_submitTenants',
        value: function _submitTenants() {
            var _this2 = this;

            // Disable the form
            this.setState({ loading: true });

            var tenantsToAdd = _.difference(this.state.tenants, this.props.group.tenants);
            var tenantsToRemove = _.difference(this.props.group.tenants, this.state.tenants);

            var actions = new _actions2.default(this.props.toolbox);
            actions.doHandleTenants(this.props.group.name, tenantsToAdd, tenantsToRemove).then(function () {
        ...
        value: function render() {
            ...
            var group = (0, _assign2.default)({}, { name: '' }, this.props.group);
...
TenantsModal.initialState = {
    loading: false,
    tenants: [],
    errors: {}
};
exports.default = TenantsModal;
;

},{"./actions":114,"babel-runtime/core-js/object/assign":1,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/extends":11,"babel-runtime/helpers/inherits":12,"babel-runtime/helpers/possibleConstructorReturn":13}],112:[function(require,module,exports){
'use strict';
...
var _GroupDetails = require('./GroupDetails');
...
var _TenantsModal = require('./TenantsModal');

var _TenantsModal2 = _interopRequireDefault(_TenantsModal);
 ...
 * Created by jakubniezgoda on 03/02/2017.
 */
var UserGroupsTable = function (_React$Component) {
    (0, _inherits3.default)(UserGroupsTable, _React$Component);

    function UserGroupsTable(props, context) {
        (0, _classCallCheck3.default)(this, UserGroupsTable);

        var _this = (0, _possibleConstructorReturn3.default)(this, (UserGroupsTable.__proto__ || (0, _getPrototypeOf2.default)(UserGroupsTable)).call(this, props, context));
    ...
    (0, _createClass3.default)(UserGroupsTable, [{
        ...
        key: '_selectUserGroup',
        value: function _selectUserGroup(userGroup) {
            var selectedUserGroup = this.props.toolbox.getContext().getValue('userGroup');
            this.props.toolbox.getContext().setValue('userGroup', userGroup === selectedUserGroup ? null : userGroup);
        }
    }, {
        key: '_getAvailableTenants',
        value: function _getAvailableTenants(value, group) {
            var _this2 = this;
            ...
            actions.doGetTenants().then(function (tenants) {
                _this2.setState({ group: group, tenants: tenants, modalType: value, showModal: true });
        ...
        value: function _getAvailableUsers(value, group) {
            var _this3 = this;
            ...
            actions.doGetUsers().then(function (users) {
                _this3.setState({ group: group, users: users, modalType: value, showModal: true });
        ...
        key: '_showModal',
        value: function _showModal(value, group) {
            if (value === _MenuAction2.default.EDIT_TENANTS_ACTION) {
                this._getAvailableTenants(value, group);
            } else if (value === _MenuAction2.default.EDIT_USERS_ACTION) {
                this._getAvailableUsers(value, group);
            } else {
                this.setState({ group: group, modalType: value, showModal: true });
            }
        }
    }, {
        key: '_hideModal',
        ...
        key: '_deleteUserGroup',
        value: function _deleteUserGroup() {
            var _this4 = this;

            this.props.toolbox.loading(true);

            var actions = new _actions2.default(this.props.toolbox);
            actions.doDelete(this.state.group.name).then(function () {
                _this4._hideModal();
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(DataTable.Column, { label: 'Group', name: 'name', width: '30%' }),
                    React.createElement(DataTable.Column, { label: 'LDAP group', name: 'ldap_dn', width: '15%' }),
                    React.createElement(DataTable.Column, { label: '# Users', width: '10%' }),
                    React.createElement(DataTable.Column, { label: '# Tenants', width: '10%' }),
                    React.createElement(DataTable.Column, { label: '', width: '5%' }),
                    this.props.data.items.map(function (item) {
                        return React.createElement(
                            DataTable.RowExpandable,
                            { key: item.name, expanded: item.isSelected },
                            React.createElement(
                                DataTable.Row,
                                { key: item.name, selected: item.isSelected, onClick: _this5._selectUserGroup.bind(_this5, item.name) },
                                React.createElement(
                                    DataTable.Data,
                                    null,
                                    item.name
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(_MenuAction2.default, { item: item, onSelectAction: _this5._showModal.bind(_this5) })
                                )
                            ),
                            React.createElement(
                                DataTable.DataExpandable,
                                null,
                                React.createElement(_GroupDetails2.default, { data: item, toolbox: _this5.props.toolbox, onError: _this5._handleError.bind(_this5) })
                            )
                        );
                    }),
                    React.createElement(
                ...
                React.createElement(_UsersModal2.default, {
                    open: this.state.modalType === _MenuAction2.default.EDIT_USERS_ACTION && this.state.showModal,
                    group: this.state.group,
                    users: this.state.users,
                    onHide: this._hideModal.bind(this),
                    toolbox: this.props.toolbox }),
                React.createElement(_TenantsModal2.default, {
                    open: this.state.modalType === _MenuAction2.default.EDIT_TENANTS_ACTION && this.state.showModal,
                    group: this.state.group,
                    tenants: this.state.tenants,
                    onHide: this._hideModal.bind(this),
                    toolbox: this.props.toolbox }),
                React.createElement(Confirm, { title: 'Are you sure you want to remove group ' + this.state.group.name + '?',
                    show: this.state.modalType === _MenuAction2.default.DELETE_ACTION && this.state.showModal,
...
},{"./CreateModal":108,"./GroupDetails":109,"./MenuAction":110,"./TenantsModal":111,"./UsersModal":113,"./actions":114,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":12,"babel-runtime/helpers/possibleConstructorReturn":13}],113:[function(require,module,exports){
'use strict';
...
var UsersModal = function (_React$Component) {
    ...
    function UsersModal(props, context) {
        ...
        _this.state = UsersModal.initialState;
        return _this;
    }
    ...
    (0, _createClass3.default)(UsersModal, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (!this.props.open && nextProps.open) {
                this.setState((0, _extends3.default)({}, UsersModal.initialState, { users: nextProps.group.users }));
            }
        }
    }, {
        key: '_submitUsers',
        value: function _submitUsers() {
            var _this2 = this;

            // Disable the form
            this.setState({ loading: true });

            var usersToAdd = _.difference(this.state.users, this.props.group.users);
            var usersToRemove = _.difference(this.props.group.users, this.state.users);

            var actions = new _actions2.default(this.props.toolbox);
            actions.doHandleUsers(this.props.group.name, usersToAdd, usersToRemove).then(function () {
                _this2.setState({ loading: false });
                _this2.props.toolbox.refresh();
                _this2.props.onHide();
            }).catch(function (err) {
        ...
        value: function render() {
            ...
            var group = (0, _assign2.default)({}, { name: '' }, this.props.group);
            var users = (0, _assign2.default)({}, { items: [] }, this.props.users);

            var options = _.map(users.items, function (item) {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            Form.Field,
                            null,
                            React.createElement(Form.Dropdown, { placeholder: 'Users', multiple: true, selection: true, options: options, name: 'users',
...
var Actions = function () {
    ...
    (0, _createClass3.default)(Actions, [{
        key: 'doCreate',
        value: function doCreate(groupName, ldapGroup) {
            var params = _.isUndefined(ldapGroup) || _.isEmpty(ldapGroup) ? { 'group_name': groupName } : { 'group_name': groupName, 'ldap_group_dn': ldapGroup };

            return this.toolbox.getManager().doPost('/user-groups', null, params);
        }
    }, {
        key: 'doDelete',
        value: function doDelete(groupName) {
        ...
        key: 'doAddUserToGroup',
        value: function doAddUserToGroup(username, group_name) {
            return this.toolbox.getManager().doPut('/user-groups/users', null, { username: username, group_name: group_name });
        }
    }, {
        key: 'doRemoveUserFromGroup',
        value: function doRemoveUserFromGroup(username, group_name) {
            return this.toolbox.getManager().doDelete('/user-groups/users', null, { username: username, group_name: group_name });
        }
    }, {
        key: 'doAddTenantToGroup',
        value: function doAddTenantToGroup(tenant_name, group_name) {
            return this.toolbox.getManager().doPut('/tenants/user-groups', null, { tenant_name: tenant_name, group_name: group_name });
        }
    }, {
        key: 'doRemoveTenantFromGroup',
        value: function doRemoveTenantFromGroup(tenant_name, group_name) {
            return this.toolbox.getManager().doDelete('/tenants/user-groups', null, { tenant_name: tenant_name, group_name: group_name });
        }
    }, {
        key: 'doHandleUsers',
        value: function doHandleUsers(groupName, usersToAdd, usersToDelete) {
            var _this = this;

            var addActions = _.map(usersToAdd, function (username) {
                return _this.doAddUserToGroup(username, groupName);
            });
            var deleteActions = _.map(usersToDelete, function (username) {
                return _this.doRemoveUserFromGroup(username, groupName);
            });
        ...
        key: 'doHandleTenants',
        value: function doHandleTenants(groupName, tenantsToAdd, tenantsToDelete) {
            var _this2 = this;

            var addActions = _.map(tenantsToAdd, function (tenant) {
                return _this2.doAddTenantToGroup(tenant, groupName);
            });
            var deleteActions = _.map(tenantsToDelete, function (tenant) {
                return _this2.doRemoveTenantFromGroup(tenant, groupName);
            });
...
var _UserGroupsTable = require('./UserGroupsTable');

var _UserGroupsTable2 = _interopRequireDefault(_UserGroupsTable);
...
Stage.defineWidget({
    ...
    render: function render(widget, data, error, toolbox) {
        ...
        return React.createElement(_UserGroupsTable2.default, { widget: widget, data: formattedData, toolbox: toolbox });
    }
}); /**
     * Created by pposel on 30/01/2017.
     */

},{"./UserGroupsTable":112,"babel-runtime/core-js/object/assign":1}]},{},[114,108,109,110,111,112,113,115])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
